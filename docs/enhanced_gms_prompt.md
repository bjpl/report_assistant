# Enhanced :gms Good Morning Startup Prompt

**Designed for: Multi-language web development portfolio (Python, TypeScript/React, Next.js)**
...
- trigger: :gms
  replace: |
    Hi! Please help me get set up for dev today (SAVE COMPREHENSIVE RESULTS IN A daily_dev_startup_report FILE IN /daily_dev_startup_reports - if the directory doesn't already exist in this project, create it):
```
...
## DEPLOYMENT & INFRASTRUCTURE SECTIONS
...
## REPOSITORY-SPECIFIC CONTEXT SECTIONS
...
## DOCUMENTATION & KNOWLEDGE SECTIONS
...
```
Plan A: [Name - e.g., "API Hardening Sprint"]
  Objective: Improve API reliability and security
  Tasks:
  ...
  Risks: May require database schema changes
  Impact: High - Reduces production incidents, improves user experience
...
The report should be saved to `/daily_dev_startup_reports/YYYY-MM-DD_startup_report.md` with the following structure:

```markdown
# Daily Dev Startup Report
**Date:** YYYY-MM-DD
**Project:** [Project Name]
**Generated:** [Timestamp]

## Executive Summary
[2-3 paragraph overview of current state and recommendations]
...
## [MANDATORY-GMS-4] Issue Tracker Review
[Findings categorized by priority/effort...]
...
### [MANDATORY-GMS-7] Alternative Plans
...
### [MANDATORY-GMS-8] Recommendation
**Recommended Plan:** [Plan letter and name]

**Rationale:**
- **Strategic Alignment:** [Why it advances goals]
- **Balance:** [Short-term vs. long-term considerations]
- **Optimal Choice:** [Why this is the best option now]
...
### A. Code Annotations Found
[Detailed list with file paths and context]

### B. Dependency Audit Results
[Full vulnerability and outdated package lists]
...
1. **Adapt sections to project type**: Not all sections apply to every project. Skip non-applicable sections or mark as "N/A - [reason]"

2. **Focus on actionable insights**: Prioritize findings that can inform today's work

3. **Balance depth and speed**: For large codebases, sample rather than exhaustively analyze

4. **Cross-reference findings**: Connect technical debt to issues, annotations to PRs, etc.

5. **Update based on context**: If working on specific features, emphasize related sections

6. **Track improvements**: Compare reports over time to measure progress

---

## CUSTOMIZATION GUIDE

To adapt this prompt for specific project needs:

1. **Add project-specific sections**: Framework-specific checks (Next.js, FastAPI), domain-specific concerns
2. **Modify severity thresholds**: Adjust what constitutes "outdated" or "complex"
3. **Include custom tooling**: Add checks for project-specific linters, analyzers, or scripts
4. **Integrate with project workflows**: Connect to project management tools, Slack, etc.

---

**Version:** 2.0.0
**Last Updated:** 2025-11-17
**Optimized for:** Python, TypeScript/React, Next.js, Full-stack web development
